...
class WeathersControllerTest < ActionController::TestCase
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post :create, weather: { description: @weather.description, environmental_condition_ids: @weather.environmental_condition_ids, name: @weather.name }
    end
  ...
  test "should update weather" do
    patch :update, id: @weather, weather: { description: @weather.description, environmental_condition_ids: @weather.environmental_condition_ids, name: @weather.name }
    assert_redirected_to weather_path(assigns(:weather))
  end
