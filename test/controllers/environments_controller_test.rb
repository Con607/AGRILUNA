...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post :create, environment: { description: @environment.description, environmental_condition_ids: @environment.environmental_condition_ids, name: @environment.name }
    end
  ...
  test "should update environment" do
    patch :update, id: @environment, environment: { description: @environment.description, environmental_condition_ids: @environment.environmental_condition_ids, name: @environment.name }
    assert_redirected_to environment_path(assigns(:environment))
  end
