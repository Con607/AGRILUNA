...
class UnitTypesControllerTest < ActionController::TestCase
  ...
  test "should create unit_type" do
    assert_difference('UnitType.count') do
      post :create, unit_type: { abbreviation: @unit_type.abbreviation, base: @unit_type.base, metric_system: @unit_type.metric_system, name: @unit_type.name, value: @unit_type.value }
    end
  ...
  test "should update unit_type" do
    patch :update, id: @unit_type, unit_type: { abbreviation: @unit_type.abbreviation, base: @unit_type.base, metric_system: @unit_type.metric_system, name: @unit_type.name, value: @unit_type.value }
    assert_redirected_to unit_type_path(assigns(:unit_type))
  end
