...
class PayRollsControllerTest < ActionController::TestCase
  ...
  test "should create pay_roll" do
    assert_difference('PayRoll.count') do
      post :create, pay_roll: { bonus: @pay_roll.bonus, discount: @pay_roll.discount, end_date: @pay_roll.end_date, pay_roll_item_id: @pay_roll.pay_roll_item_id, start_date: @pay_roll.start_date, subtotal: @pay_roll.subtotal, total: @pay_roll.total }
    end
  ...
  test "should update pay_roll" do
    patch :update, id: @pay_roll, pay_roll: { bonus: @pay_roll.bonus, discount: @pay_roll.discount, end_date: @pay_roll.end_date, pay_roll_item_id: @pay_roll.pay_roll_item_id, start_date: @pay_roll.start_date, subtotal: @pay_roll.subtotal, total: @pay_roll.total }
    assert_redirected_to pay_roll_path(assigns(:pay_roll))
  end
