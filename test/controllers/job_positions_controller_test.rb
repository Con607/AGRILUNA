...
class JobPositionsControllerTest < ActionController::TestCase
  ...
  test "should create job_position" do
    assert_difference('JobPosition.count') do
      post :create, job_position: { description: @job_position.description, employee_ids: @job_position.employee_ids, name: @job_position.name }
    end
  ...
  test "should update job_position" do
    patch :update, id: @job_position, job_position: { description: @job_position.description, employee_ids: @job_position.employee_ids, name: @job_position.name }
    assert_redirected_to job_position_path(assigns(:job_position))
  end
